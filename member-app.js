...
function open(){$("#auth").classList.add("hidden");$("#app").classList.remove("hidden");$("#welcome").textContent=user.name+"님";$("#memberId").textContent="회원 아이디: "+user.id+" · "+((user.role||"member")==="subscriber"?"구독자":"이용자");listen()}
